<?php
define('DB_NAME', 'rockhosteltest_bd');
define('DB_USER', 'rockhosteltest');
define('DB_PASSWORD', 'ISaAefefoi73hkeee');
...
define('AUTH_KEY',  'B]9_9_%uF{fdsasgC)pMx/?-+_bVjX;Xrib=1y23rgghdh3a+dadAEIZ1O/z^2GvU&NhkNXhKI');
define('SECURE_AUTH_KEY',  'Gasgb43@t+eWU&NhkNXw1daVO,adsa>mFU*kC^;8NAi0&;2RIz}a>:uO0[yU_0Cr<IPep&GG0U');
define('LOGGED_IN_KEY',    'PvbNzyB^Z?fl|Kad..Du#4/|Y{iV|ntR22zndahar534L!k)T%~vU[5Tv4Vf*4U&NhkNX#wAK_');
